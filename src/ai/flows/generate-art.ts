...
/**
 * @fileOverview AI flow for generating art from a text prompt.
 *
 * - generateArt - A function that generates an image.
...
const GenerateArtOutputSchema = z.object({
  imageUrl: z
    .string()
    .describe("The data URI of the generated image. Expected format: 'data:<mimetype>;base64,<encoded_data>'."),
});
