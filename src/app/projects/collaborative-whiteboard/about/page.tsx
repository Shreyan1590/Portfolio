...
export default function AboutCollaborativeWhiteboardPage() {
    const project = {
        title: "Real-time Collaborative Whiteboard",
        description: "A web-based whiteboard application that allows multiple users to draw, write, and brainstorm together in real-time. It features a rich toolset and uses WebSockets for instant updates.",
