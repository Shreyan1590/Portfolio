...
export function CaseStudiesSection() {
  ...
  return (
    <section id="case-studies" className="py-16 md:py-24 bg-secondary/20" ref={ref}>
      <div
        className={cn(
      ...
      >
        ...
        <div className="max-w-6xl mx-auto">
          {caseStudiesData.map((study) => (
            <div key={study.title} className="bg-card/50 border border-border/50 rounded-xl overflow-hidden shadow-2xl shadow-primary/10 transition-all duration-300 hover:shadow-primary/30">
              <div className="grid grid-cols-1 lg:grid-cols-2">
                <div className="p-8 md:p-12 order-2 lg:order-1">
                  ...
                  <div className="grid grid-cols-3 gap-4 mb-8 text-center">
                    {study.results.map(result => (
                      <div key={result.label} className="transition-transform duration-300 hover:scale-110">
                ...
                <div className="relative min-h-[300px] lg:min-h-0 order-1 lg:order-2 overflow-hidden">
                  <Image
                    src={study.image}
