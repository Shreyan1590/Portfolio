    ...
    <section id="services" className="py-16 md:py-24 bg-secondary/20">
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {servicesData.map((service) => (
          <Card key={service.title} className="bg-card/50 border-border/50 backdrop-blur-sm text-center flex flex-col items-center p-6 transition-all duration-300 hover:border-accent hover:shadow-2xl hover:shadow-accent/20">
