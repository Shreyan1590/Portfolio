    ...
    <section id="open-source" className="py-16 md:py-24">
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {contributionsData.map((item) => (
          <Card key={item.title} className="bg-card/50 border-border/50 backdrop-blur-sm flex flex-col p-6 transition-all duration-300 hover:border-primary hover:shadow-2xl hover:shadow-primary/20">
