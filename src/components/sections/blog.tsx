...
export function BlogSection() {
  return (
    <section id="blog" className="py-16 md:py-24 fade-in-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {blogData.map((post) => (
          <Card key={post.title} className="flex flex-col overflow-hidden group hover:shadow-2xl hover:shadow-primary/20 transition-all duration-300 bg-card/50 hover:-translate-y-2 border-border/50 backdrop-blur-sm">
