  ...
  return (
    <section id="hero" className="relative w-full h-[90vh] min-h-[700px] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
        <h1 
          className="hero-animate text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-headline font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-primary"
          style={{ animationDelay: '0.2s' }}
        >
          Shreyan S.
        </h1>
        <p 
          className="hero-animate mt-6 max-w-3xl mx-auto text-lg md:text-xl text-muted-foreground"
        ...
        <div 
          className="hero-animate mt-10 flex flex-col sm:flex-row justify-center gap-4"
